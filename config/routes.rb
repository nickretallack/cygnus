Rails.application.routes.draw do
  ...
  get    "reset/"+":"+User.slug.to_s+"/:activation" => "users#reset_return", as: :send_password_reset
  patch   "reset/"+":"+User.slug.to_s+"/:activation" => "users#reset_return_confirm"
  ...
  get ":"+User.slug.to_s+"/gallery", to: "pools#show", as: :gallery

  get "image/:type(/:id)", to: "images#show", as: :image
  post ":"+User.slug.to_s+"/avatar" => "images#create", as: :new_avatar

  get "pools(/:"+User.slug.to_s+")" => "pools#index" , as: :pools
  get "pools/:"+Pool.slug.to_s => "pools#show", as: :pool
